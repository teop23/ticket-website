      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {steps.map((step, index) => (
            <div 
              key={index} 
              className="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/50 p-6 text-center relative transition-all duration-300 hover:shadow-xl hover:transform hover:-translate-y-1"
            >
        ...
        <div className="mt-16 max-w-4xl mx-auto bg-gray-100 dark:bg-gray-800 rounded-xl p-6">
