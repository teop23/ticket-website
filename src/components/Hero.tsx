...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-20 sm:pt-24 md:pt-16 pb-12 sm:pb-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-8 sm:mb-12">
          ...
          />
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-red-600 dark:text-red-500 mb-6 leading-[1.2]">
            Win Big Every Hour
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto mb-8 px-2 sm:px-4">
            {hero.description}
          </p>
          <button className="btn-primary dark:bg-gradient-to-r dark:from-red-600 dark:to-red-700 dark:hover:from-red-700 dark:hover:to-red-800">
            Buy $TICKET Now
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
          {/* Next Drawing */}
          <div className="glass-card dark:bg-gray-800/80 dark:border-gray-700/20 rounded-2xl p-4 sm:p-6 hover-scale flex flex-col justify-center min-h-[220px] sm:min-h-[280px] md:min-h-[300px]">
          ...
          {/* Estimated Jackpot */}
          <div className="bg-gradient-to-br from-red-600 to-red-800 dark:from-red-700 dark:to-red-900 rounded-2xl shadow-lg p-4 sm:p-6 text-center transform hover:scale-105 transition-transform duration-300 flex flex-col justify-center min-h-[220px] sm:min-h-[280px] md:min-h-[300px]">
          ...
          {/* Last 3 Winners */}
          <div className="glass-card dark:bg-gray-800/80 dark:border-gray-700/20 rounded-2xl p-3 hover-scale min-h-[220px] sm:min-h-[280px] md:min-h-[300px] flex flex-col">
            ...
            <div className="space-y-3 flex-grow">
              {winners.length > 0 ? winners.map((winner, index) => (
                ...
                <div className="text-center py-8">
                  <ShieldCheck size={32} className="text-red-600/50 dark:text-red-400/50 mx-auto mb-3" />
