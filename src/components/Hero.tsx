      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-20">
          <img 
            ...
            alt="Power Millions"
            className="w-96 mx-auto mb-8 hover-scale"
          />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="glass-card rounded-2xl p-8 hover-scale">
            ...
            <div className="flex justify-center gap-2">
              <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-lg px-6 py-4">
          ...
          {/* Estimated Jackpot */}
          <div className="bg-gradient-to-br from-red-600 to-red-800 rounded-2xl shadow-lg p-8 text-center transform hover:scale-105 transition-transform duration-300">
