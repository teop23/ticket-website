    ...
    <div className="pt-16 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-100 mb-4">How to Play Power Millions</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Hourly Draws</h3>
            <p className="text-gray-600 dark:text-gray-300">New winner every hour</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Raffle Entries</h3>
            <p className="text-gray-600 dark:text-gray-300">100 tokens = 1 entry</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Better Odds</h3>
            <p className="text-gray-600 dark:text-gray-300">More tokens = more chances</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">VRF Verified</h3>
            <p className="text-gray-600 dark:text-gray-300">Verifiable on-chain</p>
          </div>
        </div>

        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-8 text-center">Step-by-Step Guide</h2>
          ...
          <div className="space-y-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Set Up Your Solana Wallet</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Buy $TICKET Tokens</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                  ...
                  <div className="bg-yellow-50 dark:bg-yellow-900/30 p-4 rounded-lg">
                    <p className="text-sm text-yellow-800 dark:text-yellow-300 font-medium mb-2">Entry System:</p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Wait for the Hourly Draw</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Check Results & Claim Winnings</h3>
